...
using UnityEngine;
using UnityEngine.SceneManagement;            //sahneler arasý geçiþ yapabilöek için 
...
public class OyunKontrol : MonoBehaviour
{
    ...
    public void OyunuBitir() // Oyun biteceði zaman çaðýrýlmasý gereken her yere haber vermemiz gerekiyor
    {
